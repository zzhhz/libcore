 ...
 */
public class HViewGroup extends FrameLayout implements View.OnClickListener
{
    /**
    ...
    public HViewGroup(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }
     ...
     * @return
     */
    public HViewGroup setContainer(View container)
    {
        if (container == null)
        {
            mContainer = null;
